...
- high - третий приоритет. Функционал блокируется частично
...
- Frontend - задача для разработчиков пользовательской части приложения
- Analysis - задача на аналитика
...
Пример задачи в GitHub: https://github.com/dalum11/saucedemo/issues/13
...
Пример оформления бага в GitHub: https://github.com/dalum11/saucedemo/issues/14
